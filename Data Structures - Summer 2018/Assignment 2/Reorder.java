/** Reorder interface for CS 0445 Assignment 2
...
public interface Reorder
{
	 ...
	 * a DS has 8 nodes in it (numbered from 1 to 8), a leftShift of 3 would 
	 ...
	 * DS, the result should be an empty DS.
	 * @param num the number of positions to shift left
	 */
	public void leftShift(int num);


	/** Same idea as leftShift above, but in the opposite direction.  For example, 
	 * if the DS has 8 nodes in it (numbered from 1 to 8) a rightShift of 3 would 
	 * shift out nodes 8, 7 and 6 and the old node 5 would now be the last node
	 * in the DS.  If num <= 0 rightShift should do nothing and if num >= the 
	 * length of the DS, the result should be an empty DS.
	 * @param num the number of positions to shift right
	 */
