...
public class JavaDemo {
    private static final String username = "USERNAME"; //Changed for confidential purposes.
    private static final String password = "PASS"; //Changed for confidential purposes.
