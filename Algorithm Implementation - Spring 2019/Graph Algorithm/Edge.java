//Edited by Landon Higinbotham for Project 4 of CS 1501
...
public class Edge implements Comparable<Edge> { 
    ...
    public double latency() {
        if (type == "optical")
        {
            return (double) length/230000000;
        }
        else //it should then be copper
        {
            return (double) length/200000000;
        }
    }
    ...
    public String toString() {
        return v+"->"+w+" with a latency of "+latency();
    }
